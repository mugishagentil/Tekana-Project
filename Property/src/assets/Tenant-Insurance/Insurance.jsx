...
function Component1() {
  return (
    ...
    <Container>
      ...
      <Row>
        <Col className='Left-Row'> <div className="content">
            ...
            <p style={{fontSize: "17px", color: '##000000ef', fontWeight: '300'}}>Quick, Affordable, and Convenient <br />
    ...
    <Container>
      ...
      <Col><img src={HomeImg} alt="" className='HomeImg Block'/></Col>
        <Col className='Left-Row'> <div className="content">
            ...
            <p className='Block' style={{fontSize: "17px", color: '##000000ef', fontWeight: '300'}}>For an incredibly low premium, renter’s insurance covers the
    ...
    <div className="contant-container">
        ...
        <p style={{fontSize: "17px", color: '##000000ef', fontWeight: '300'}}>You have the flexibility to pick and choose the elements thatmatter to you, ensuring that you are never paying for coverage you don't need. Whether it's protecting
      ...
      <Row>
        <Col className='Left-Row'> <div className="content">
            ...
            <p style={{fontSize: "17px", color: '##000000ef', fontWeight: '300'}}>Your belongings will be covered against
