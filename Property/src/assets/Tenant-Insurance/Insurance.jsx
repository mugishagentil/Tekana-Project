...
function Component1() {
  return (
    ...
    <Container>
      ...
      <Row>
        <Col className='Left-Row'> <div className="content">
            ...
            <p>Quick, Affordable, and Convenient <br />
    ...
    <Container>
      ...
      <Col><img src={HomeImg} alt="" className='HomeImg Block'/></Col>
        <Col className='Left-Row'> <div className="content">
            ...
            <p className='Block'>For an incredibly low premium, renter’s insurance covers the
    ...
    <div className="contant-container">
        ...
        <p>You have the flexibility to pick and choose the elements thatmatter to you, ensuring that you are never paying for coverage you don't need. Whether it's protecting
      ...
      <Row>
        <Col className='Left-Row'> <div className="content">
            ...
            <p >Your belongings will be covered against
