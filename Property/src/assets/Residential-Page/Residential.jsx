  ...
  return (
    ...
    <Container>
      ...
      <Col><img src={Img} alt="" className='HomeImg Block'/></Col>
        ...
        <p className='Block' style={{fontSize: "17px", color: '##000000ef', fontWeight: '300'}}>Our platform keeps you connected with your tenants through direct chat, announcements, and automated reminders. Say goodbye to missed messages and ensure that your tenants always feel heard and valued.</p>
        </Col>
      </Row>
      {/* Component-Two */}
      {/* Component-Three */}
