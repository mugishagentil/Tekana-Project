...
function Commercial2() {
  return (
    ...
    <div className="leftside-container">
      ...
      <p style={{fontSize: "17px", color: '##000000ef', fontWeight: '300'}}> Managing commercial properties comes with its own set of challenges, but with Tekana, you can navigate these complexities effortlessly. Our platform is designed to address the specific needs of office spaces, retail locations, and industrial properties, offering a streamlined approach to property management.</p>
    </div>
    ...
    <Container>
      ...
      <Col><img src={Img} alt="" className='HomeImg Block'/></Col>
        ...
        <p style={{fontSize: "17px", color: '##000000ef', fontWeight: '300'}} className='Block'>Your renters are running a business and they expect a professional experience for their rental. With Tekana clean and modern look and feel, your renters will be impressed with the level of polish you bring to your business.</p>
        </Col>
      </Row>
      {/* Component-Two */}
      {/* Component-Three */}
   ...
   <div className="rightside-container">
    ...
    <div className="leftside-container">
      ...
      <p style={{fontSize: "17px", color: '##000000ef', fontWeight: '300'}}>3. Financial Tracking Made Simple
