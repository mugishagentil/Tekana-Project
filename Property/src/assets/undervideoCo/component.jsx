...
function Component(){
    ...
    <span className='save-money2 Block'> Way to Manage</span>
      ...
      <p className='Tekana-Paragraph Block' ><span style={{fontSize: '17px', color: '#000000', fontWeight: '800'}}>For Landlords:</span> Stay informed and in control! With Tekana System, you can easily access real-time information about your properties and tenants. Monitor occupancy, lease details, and payment status all in one place. Gain insights that help you maximize your property’s potential while maintaining a great relationship with your tenants.</p>
      <p className='Tekana-Paragraph Block' ><span style={{fontSize: '17px', color: '#000000', fontWeight: '800'}}>For Tenant:</span> Enjoy a better rental experience with Tekana System! Submit maintenance requests, track payments, and access important information anytime, anywhere. Our platform connects you directly with your landlord or property manager, ensuring that your needs are met quickly and efficiently. We’re here to make your rental experience hassle-free and enjoyable.</p>
